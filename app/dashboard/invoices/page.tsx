...
/* Esta Page cuenta con los componentes Search y Table.
En Search el usuario realiza el input del customer que necesite buscar.
El nombre del customer se pasa a traves de parámetros en la url.
 */
